...
and :data:`~ScrollEffect.max` properties. If the movement exceeds these bounds,
it will calculate the amount of :data:`~ScrollEffect.overscroll` and try to
return to the value of one of the bounds.
